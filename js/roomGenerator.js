...
rooms[5] = '<!--domatio pros antallagi mono--><div class="col-xl-3 col-lg-4 col-md-6 mb-4"> <div class="bg-white rounded shadow-sm"><img src="./img/6.jpg" alt="" class="img-fluid card-img-top"> <div class="p-4"> <h5> <a href="#" class="text-dark">Artistic House near Acropolis</a></h5> <p class="small text-muted mb-0">2 Επισκέπτες • 1 Υπνοδωμάτιο • 1 Κρεβάτι • 1,5 Μπάνια</p> <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4"> <p class="small mb-0"></p> <div class="badge badge-primary px-3 rounded-pill font-weight-normal">Ανταλλαγή</div> </div> </div> </div> </div><!--telos domatiou pros antallagi mono-->';
rooms[6] = '<!--domatio eite pros antallagi eite pros enoikiasi--><div class="col-xl-3 col-lg-4 col-md-6 mb-4"> <div class="bg-white rounded shadow-sm"><img src="./img/7.jpg" alt="" class="img-fluid card-img-top"> <div class="p-4"> <h5> <a href="#" class="text-dark">Amazing view at the park</a></h5> <p class="small text-muted mb-0">4 Επισκέπτες • 2 Υπνοδωμάτια • 4 Κρεβάτια • 1 Μπάνιο</p> <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4"> <p class="small mb-0">90€/Διανυκτέρευση</p> <div class="badge badge-success px-3 rounded-pill font-weight-normal">Ανταλλαγή/Ενοικίαση</div> </div> </div> </div> </div><!--telos domatiou pros antallagi i pros enoikiasi-->';
rooms[7] = '<!--domatio pros antallagi mono--><div class="col-xl-3 col-lg-4 col-md-6 mb-4"> <div class="bg-white rounded shadow-sm"><img src="./img/8.jpg" alt="" class="img-fluid card-img-top"> <div class="p-4"> <h5> <a href="#" class="text-dark">Keramikos Cosy Nest</a></h5> <p class="small text-muted mb-0">2 Επισκέπτες • 1 Υπνοδωμάτιο • 1 Κρεβάτι • 1 Μπάνιο</p> <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4"> <p class="small mb-0"></p> <div class="badge badge-primary px-3 rounded-pill font-weight-normal">Ανταλλαγή</div> </div> </div> </div> </div><!--telos domatiou pros antallagi mono-->';
rooms[8] = '<!--domatio pros enoikiasi mono--><div class="col-xl-3 col-lg-4 col-md-6 mb-4"> <div class="bg-white rounded shadow-sm"><img src="./img/9.jpg" alt="" class="img-fluid card-img-top"> <div class="p-4"> <h5> <a href="#" class="text-dark">Student Room with Acropolis View</a></h5> <p class="small text-muted mb-0">1 Επισκέπτης • 1 Χώρος • 1 Κρεβάτι • 1 Μπάνιο</p> <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4"> <p class="small mb-0">50€/Διανυκτέρευση</p> <div class="badge badge-danger px-3 rounded-pill font-weight-normal">Ενοικίαση</div> </div> </div> </div> </div><!--telos domatiou pros enoikiasi mono-->';
rooms[9] = '<!--domatio eite pros antallagi eite pros enoikiasi--><div class="col-xl-3 col-lg-4 col-md-6 mb-4"> <div class="bg-white rounded shadow-sm"><img src="./img/10.jpg" alt="" class="img-fluid card-img-top"> <div class="p-4"> <h5> <a href="#" class="text-dark">Apartment next to Museum</a></h5> <p class="small text-muted mb-0">2 Επισκέπτες • 1 Υπνοδωμάτιο • 1 Κρεβατια • 1 Μπάνιο</p> <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4"> <p class="small mb-0">90€/Διανυκτέρευση</p> <div class="badge badge-success px-3 rounded-pill font-weight-normal">Ανταλλαγή/Ενοικίαση</div> </div> </div> </div> </div><!--telos domatiou pros antallagi i pros enoikiasi-->';
rooms[10] = '<!--domatio eite pros antallagi eite pros enoikiasi--><div class="col-xl-3 col-lg-4 col-md-6 mb-4"> <div class="bg-white rounded shadow-sm"><img src="./img/11.jpg" alt="" class="img-fluid card-img-top"> <div class="p-4"> <h5> <a href="#" class="text-dark">In the heart of Athens</a></h5> <p class="small text-muted mb-0">4 Επισκέπτες • 2 Υπνοδωμάτια • 2 Κρεβάτια • 1 Μπάνιο</p> <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4"> <p class="small mb-0">90€/Διανυκτέρευση</p> <div class="badge badge-success px-3 rounded-pill font-weight-normal">Ανταλλαγή/Ενοικίαση</div> </div> </div> </div> </div><!--telos domatiou pros antallagi i pros enoikiasi-->';
